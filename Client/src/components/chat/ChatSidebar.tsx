        ...
        {isMobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed left-0 top-0 h-full w-80 bg-white/90 dark:bg-gray-900/95 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-800/50 flex flex-col py-6 gap-2 z-50 shadow-2xl"
            >
              {/* Mobile Header */}
                      ...
                      >
                        ...
                        {isActive && (
                          <motion.div
                            ...
                            className="ml-auto w-2 h-8 bg-white rounded-l-full"
                          />
                        )}
                      </Link>
                    </motion.div>
