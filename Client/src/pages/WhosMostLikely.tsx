...
// UPDATED: Enhanced ChatInput component with FIXED typing indicators
...
// NEW: Enhanced ChatPanel component with FIXED typing indicators
...
const WhosMostLikely = () => {
  ...
  // UPDATED: Chat states with proper typing handling
  ...
  // UPDATED: Enhanced mobile CSS with better viewport handling
  useEffect(() => {
    const styles = `
  ...
  // UPDATED: Enhanced mobile scrolling
  useEffect(() => {
  ...
  // UPDATED: Chat message handler with proper typing
  ...
  // UPDATED: Handle typing start
  const handleTyping = () => {
    if (!socket) return;
    socket.emit("typing", { roomId, userId: playerName, userName: playerName });
  };

  // UPDATED: Handle typing stop
  const handleStopTyping = () => {
    if (!socket) return;
    socket.emit("chat-typing-stop", { roomId, userId: playerName });
  };

  // UPDATED: Enhanced chat toggle with better mobile handling
  const toggleChat = () => {
    setShowChat(!showChat);
  };

  // Socket event handlers - KEEPING YOUR ORIGINAL GAME LOGIC
  useEffect(() => {
    ...
    // UPDATED: Chat event handlers with proper typing
    ...
    // UPDATED: Chat listeners with proper typing
    ...
    return () => {
      ...
      // UPDATED: Chat listeners cleanup
  ...
  // KEEPING YOUR ORIGINAL GAME FUNCTIONS
  const createRoom = () => {
    if (!playerName.trim()) {
  ...
  // UPDATED: Enhanced Mobile Chat Toggle Button
  ...
  // KEEPING YOUR ORIGINAL UI STRUCTURE - Only enhancing the chat integration
  ...
  // UPDATED: All game screens with enhanced chat integration
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1 min-h-0 px-2 pb-6">
                ...
                <div className="lg:col-span-2 flex flex-col min-h-0">
                  <Card className="p-4 sm:p-6 bg-white/10 backdrop-blur-lg border-0 shadow-2xl flex-1 flex flex-col min-h-0">
                    {/* Your original waiting room content remains exactly the same */}
                ...
                {/* UPDATED: Chat Panel with proper integration */}
                {showChat && (
                  <>
  ...
  // Game Finished Screen - UPDATED with chat integration
  if (gameFinished) {
    return (
      <div className="mobile-viewport-fix bg-gradient-to-br from-blue-900 via-purple-800 to-pink-900">
        <div className="mobile-scroll-container">
          <div className="game-content-container content-safe-area">
            ...
            <div ref={mainContainerRef} className="max-w-6xl mx-auto relative z-10 min-h-full flex flex-col safe-area-padding">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1 min-h-0 px-2 pb-6">
                {/* Main Content - Your original content */}
                <div className="lg:col-span-2 flex flex-col min-h-0">
                  <Card className="p-4 sm:p-6 bg-white/10 backdrop-blur-lg border-0 shadow-2xl flex-1 flex flex-col min-h-0">
                    <div className="text-center mb-6">
  ...
  // Round Results Screen - UPDATED with chat integration
  if (roundResults) {
    return (
      <div className="mobile-viewport-fix bg-gradient-to-br from-blue-900 via-purple-800 to-pink-900">
        <div className="mobile-scroll-container">
  ...
  // Main Game Screen - UPDATED with chat integration
  return (
    <div className="mobile-viewport-fix bg-gradient-to-br from-blue-900 via-purple-800 to-pink-900">
      <div className="mobile-scroll-container">
        <div className="game-content-container content-safe-area">
          ...
          <div ref={mainContainerRef} className="max-w-6xl mx-auto relative z-10 min-h-full flex flex-col safe-area-padding">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1 min-h-0 px-2 pb-6">
              {/* Main Game Content - Your original content */}
              <div className="lg:col-span-2 flex flex-col min-h-0">
                {/* Header */}
