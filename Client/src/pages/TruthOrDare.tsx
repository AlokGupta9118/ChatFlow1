...
export default function TruthOrDare({ currentUser }) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-2xl relative z-10">
          <Card className="p-8 bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl border-0">
            <div className="text-center mb-8">
              <div className="flex justify-center items-center mb-4">
                <Gamepad2 className="w-12 h-12 text-purple-600 mr-3" />
                <h1 className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                  Truth or Dare
                </h1>
              </div>
              <p className="text-gray-600 text-lg">Create or join a room to start playing with friends!</p>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <div>
                  ...
                  <Input 
                    ...
                    className="text-lg py-6 border-2 focus:border-purple-500 transition-all"
                  />
                </div>
                <div>
                  ...
                  <Input 
                    ...
                    className="text-lg py-6 border-2 focus:border-purple-500 transition-all font-mono uppercase"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <Button 
                  ...
                  className="flex-1 py-6 text-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg transition-all duration-300"
                >
                ...
                <Button 
                  onClick={createRoom} 
                  disabled={!socket} 
                  className="flex-1 py-6 text-lg bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white shadow-lg transition-all duration-300"
                >
  ...
  // 🧩 Game UI
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6 relative">
      {/* Animated background */}
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(15)].map((_, i) => (
          <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Header */}
        <div className="flex justify-between items-center mb-6 p-4 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
          <div className="flex items-center space-x-4">
            <div>
              <h2 className="text-xl font-bold text-white">Room Code</h2>
              <div className="font-mono text-2xl font-bold text-yellow-300 bg-black/30 px-3 py-1 rounded-lg">
                {roomId}
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="flex items-center space-x-2">
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                className="h-8 w-8 p-0 bg-green-100 hover:bg-green-200 border-green-300"
                              >
                      ...
                      {gameSettings.enableScoring && (
                        <div className="text-right">
                          <div className="text-sm font-bold text-gray-900">{scores[player.name] || 0}</div>
              ...
              <div className="mt-6 space-y-4">
                {stage === "waiting" && isHost && (
                  <Button 
                    ...
                    className="w-full py-6 text-lg bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white shadow-lg"
                ...
                {stage === "playing" && !selectedPlayer && (
                  <Button 
                    ...
                    className="w-full py-6 text-lg bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white shadow-lg transition-all duration-300"
                  >
                    {spinning ? (
                      <>
                ...
                {isHost && selectedPlayer && proofUploaded && (
                  <Button 
                    onClick={resetRound} 
                    className="w-full py-6 text-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg transition-all duration-300"
                  >
                    Next Round
                  </Button>
                )}
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Timer Duration: {gameSettings.timerDuration}s
                    </label>
                    <input
                      type="range"
                      min="10"
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Spinner Wheel */}
            {stage === "playing" && (
              <Card className="p-6 bg-white/95 backdrop-blur-sm shadow-xl rounded-2xl border-0 text-center">
                <SpinnerWheel 
                  players={players} 
              ...
              <Card className="p-6 bg-white/95 backdrop-blur-sm shadow-xl rounded-2xl border-0">
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-6 py-3 rounded-full shadow-lg">
                      <Sparkles className="w-5 h-5" />
                      <h3 className="text-xl font-bold">Selected Player</h3>
                      <Sparkles className="w-5 h-5" />
                    </div>
                    <div className="mt-4">
                      ...
                      <h2 className="text-3xl font-bold text-gray-900">{selectedPlayer}</h2>
                      {timeLeft !== null && (
                        <div className="mt-2">
                  ...
                  {selectedPlayer === localName && isChoicePending && (
                    <div className="text-center space-y-4">
                      <h4 className="text-lg font-semibold text-gray-900">Choose your fate:</h4>
                      <div className="flex justify-center gap-6">
                        <Button 
                          onClick={() => submitTruthDare("Truth")} 
                          className="px-8 py-6 text-lg bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white shadow-lg transition-transform hover:scale-105"
                        >
                          💬 Truth
                        </Button>
                        <Button 
                          onClick={() => submitTruthDare("Dare")} 
                          className="px-8 py-6 text-lg bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white shadow-lg transition-transform hover:scale-105"
                        >
                          ⚡ Dare
                        </Button>
                      </div>
                  ...
                  {truthDareChoice && truthDareChoice.player === selectedPlayer && (
                    <Card className="p-6 bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 text-center">
                        ...
                        {!proofUploaded ? (
                          <>
                            <p className="text-gray-600 mb-4">
                              Complete your {chosenPrompt.type.toLowerCase()} and upload proof!
                            </p>
                            <div className="flex flex-col items-center space-y-3">
                              ...
                              <Button
                                ...
                                className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-3 px-6"
                              >
                          ...
                          <>
                            ...
                            <div className="relative inline-block">
                              <img
                                src={proofImage}
                                alt="Proof"
                                className="max-w-full h-48 object-cover rounded-lg shadow-md border-2 border-green-300"
                              />
                              <Button
                                variant="destructive"
                                size="sm"
                    ...
                    <Card className="p-6 bg-gray-50 border-2 border-gray-200">
                      <Tabs value={promptType} onValueChange={setPromptType} className="w-full">
                        <TabsList className="grid w-full grid-cols-2 mb-4">
                          <TabsTrigger value="truth" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
                            💬 Truth
                          </TabsTrigger>
                          <TabsTrigger value="dare" className="data-[state=active]:bg-red-600 data-[state=active]:text-white">
                            ⚡ Dare
                          </TabsTrigger>
                        </TabsList>
                        <TabsContent value={promptType} className="space-y-4">
                          <div className="flex gap-3">
                            <Input 
                              value={promptText} 
                              onChange={(e) => setPromptText(e.target.value)}
                              placeholder={`Write a ${promptType} prompt for ${selectedPlayer}...`}
                            ...
                            <div className="flex justify-between items-start">
                              <div className="flex-1">
                                <div className="flex items-center space-x-2 mb-2">
                                  ...
                                  <span className="text-sm text-gray-600">from {pr.from}</span>
                                </div>
                                <div className="font-medium text-gray-900 text-lg">{pr.text}</div>
                              </div>
                  ...
                  {/* Chosen Prompt */}
                  {chosenPrompt && (
                    <Card className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 shadow-lg">
                      <div className="text-center">
                        <div className="text-sm text-gray-600 mb-2">Chosen Prompt</div>
                        <div className="text-2xl font-bold text-gray-900 mb-4">{chosenPrompt.text}</div>
                  ...
                  {/* Admin Notice */}
                  {isHost && selectedPlayer && !proofUploaded && (
                    <Card className="p-4 bg-yellow-50 border-2 border-yellow-200 text-center">
                      <div className="text-yellow-800 font-medium">
                        ⏳ Waiting for {selectedPlayer} to upload proof...
                      </div>
                    </Card>
                  )}
                </div>
          ...
          {showChat && (
            <div className="space-y-6">
              <Card className="h-[600px] flex flex-col bg-white/95 backdrop-blur-sm shadow-xl rounded-2xl border-0">
          ...
          <Card className="max-w-2xl w-full bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl border-0">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-gray-900">Proof Submission</h3>
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => {
                ...
                {currentProof ? (
                  <div className="space-y-4">
                    <img
                      ...
                      className="max-w-full h-96 object-contain rounded-lg border-2 border-gray-200 mx-auto"
                    />
...
function SpinnerWheel({ players, selectedPlayer, spinning, soundEnabled }) {
  ...
  return (
    <div className="relative w-80 h-80 mx-auto">
      <div
        ref={wheelRef}
        className="w-full h-full rounded-full border-8 border-white relative flex items-center justify-center bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 shadow-2xl"
        style={{
          boxShadow: '0 0 30px rgba(255, 255, 255, 0.3)'
        }}
      >
        {/* Center circle */}
        <div className="absolute w-20 h-20 bg-white rounded-full shadow-inner flex items-center justify-center">
        ...
        {players.map((p, idx) => {
          ...
          return (
            <div
              key={p.name}
              className={`absolute w-40 text-center font-bold transition-all duration-500 ${
                isWinner 
                  ? "scale-125 text-yellow-300 drop-shadow-xl z-10 animate-bounce" 
                  : "text-white drop-shadow-md"
              } ${isLargeSegment ? 'text-lg' : 'text-sm'}`}
              style={{ 
      ...
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-2">
        <div className="w-6 h-8 bg-yellow-400 rounded-t-lg shadow-lg" />
        <div className="w-4 h-4 bg-yellow-400 transform rotate-45 mx-auto -mt-2 shadow-lg" />
      </div>
    </div>
  );
}
    ...
    <div className="fixed top-4 right-4 flex flex-col gap-3 z-50 max-w-sm">
      {toasts.map((t) => (
        <div 
          key={t.id} 
          className={`
            p-4 rounded-xl shadow-2xl backdrop-blur-sm border transform transition-all duration-500 animate-in slide-in-from-right-80
            ${t.type === 'error' 
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            {t.type === 'error' && <div className="w-5 h-5">⚠️</div>}
